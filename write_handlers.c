...
{ /* char stored at left and paddind at buffer's right */
	int i = 0;
	char padd = ' ';
...
int write_unsgnd(int is_negative, int ind,
	...
	int flags, int width, int precision, int size)
{
	/* The number is stored the bufer's right and starts at position i */
 ...
 * @ind: Index where the number starts in buffer
 * @buffer: Chars array
 * @width: Specifier of width
 * @length: Number length
 * @padd: Char indicating the padding
 * @extra_c: Char indicating extra char
 * @flags: Specifier of flag
